...
QT_MOC_LITERAL(7, 45, 14),
QT_MOC_LITERAL(8, 60, 7),
QT_MOC_LITERAL(9, 68, 16),
...
QT_MOC_LITERAL(16, 168, 4)
    ...
    "Updater\0updateFinished\0\0ok\0utd\0sendLine\0"
    "line\0modifyLastLine\0startDl\0"
    "hideSplashScreen\0restartNeeded\0"
    "startUpdate\0receiveProgress\0bytesReceived\0"
    "bytesTotal\0receiveFinishdl\0data\0"
};
...
void Updater::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->updateFinished((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        ...
        case 5: _t->restartNeeded(); break;
        case 6: _t->startUpdate(); break;
        case 7: _t->receiveProgress((*reinterpret_cast< qint64(*)>(_a[1])),(*reinterpret_cast< qint64(*)>(_a[2]))); break;
        case 8: _t->receiveFinishdl((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Updater::*_t)(bool , bool );
        ...
        {
            typedef void (Updater::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Updater::restartNeeded)) {
                *result = 5;
            }
        }
    }
...
// SIGNAL 0
void Updater::updateFinished(bool _t1, bool _t2)
{
